...
export const it: Dictionary = {
  ...
  "download": {
    ...
    "coprTitle": "Su Fedora? Usa il repo COPR",
    "coprBody": "Build per Fedora 43, 44 e Rawhide. Gli aggiornamenti arrivano con il resto del sistema tramite {code}. Dettagli sulla {link}.",
    "coprLink": "pagina del progetto COPR",
    "coprCopy": "Copia comando",
    "coprCopied": "Copiato",
    "appimageTitle": "AppImage",
    "appimageBody": "Include le informazioni di aggiornamento zsync: esegui AppImageUpdate sul file per un aggiornamento differenziale.",
    "flatpakTitle": "Flatpak",
    "flatpakBody": "Il bundle è un sideload. Riscaricalo per aggiornarlo finché Unisic non arriva su Flathub.",
    "debTitle": "deb, Arch",
    "debBody": "Installa il nuovo pacchetto sopra il vecchio. Preferisci compilare dai sorgenti? Il README ti spiega tutto.",
