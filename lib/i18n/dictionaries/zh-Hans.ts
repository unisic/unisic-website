...
export const zhHans: Dictionary = {
  ...
  "download": {
    ...
    "coprTitle": "用 Fedora？使用 COPR 仓库",
    "coprBody": "提供面向 Fedora 43、44 和 Rawhide 的构建。更新会随系统的其余部分一起通过 {code} 到达。详情见{link}。",
    "coprLink": "COPR 项目页面",
    "coprCopy": "复制命令",
    "coprCopied": "已复制",
    "appimageTitle": "AppImage",
    "appimageBody": "附带 zsync 更新信息：对该文件运行 AppImageUpdate 即可进行差量更新。",
    "flatpakTitle": "Flatpak",
    "flatpakBody": "该捆绑包为旁加载安装。在 Unisic 登陆 Flathub 之前，需重新下载以更新。",
    "debTitle": "deb、Arch",
    "debBody": "用新软件包覆盖安装旧的。更愿意从源码构建？README 里都写好了。",
