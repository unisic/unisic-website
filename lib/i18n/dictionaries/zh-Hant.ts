...
export const zhHant: Dictionary = {
  "meta": {
    "title": "Unisic — 在 Linux Wayland 上把截圖做對",
    "description": "適用於 Linux Wayland 的開源截圖與螢幕錄影工具。截圖前先標註，事後再編輯，錄製 GIF 與影片，隨處上傳。零遙測，GPLv3。",
    "ogTitle": "Unisic — 在 Linux Wayland 上把截圖做對",
  ...
  "hero": {
    "headline": "在 Linux Wayland 上把截圖做對。",
  ...
  "download": {
    ...
    "coprTitle": "使用 Fedora？請用 COPR 軟體庫",
    "coprBody": "提供 Fedora 43、44 與 Rawhide 的組建。更新會透過 {code} 隨系統其餘部分一併送達。詳情請見 {link}。",
    "coprLink": "COPR 專案頁面",
    "coprCopy": "複製命令",
    "coprCopied": "已複製",
    "appimageTitle": "AppImage",
    "appimageBody": "隨附 zsync 更新資訊：對檔案執行 AppImageUpdate 即可進行差異更新。",
    "flatpakTitle": "Flatpak",
    "flatpakBody": "這個套件包屬於側載安裝。在 Unisic 登上 Flathub 之前，請重新下載以更新。",
    "debTitle": "deb、Arch",
    "debBody": "直接以新套件覆蓋安裝舊套件。偏好從原始碼組建？README 已為你準備好。",
