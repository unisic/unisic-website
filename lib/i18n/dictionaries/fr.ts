...
export const fr: Dictionary = {
  ...
  "download": {
    ...
    "coprTitle": "Sur Fedora ? Utilisez le dépôt COPR",
    "coprBody": "Builds pour Fedora 43, 44 et Rawhide. Les mises à jour arrivent avec le reste du système via {code}. Détails sur la {link}.",
    "coprLink": "page du projet COPR",
    "coprCopy": "Copier la commande",
    "coprCopied": "Copié",
    "appimageTitle": "AppImage",
    "appimageBody": "Fournit les informations de mise à jour zsync : lancez AppImageUpdate sur le fichier pour une mise à jour différentielle.",
    "flatpakTitle": "Flatpak",
    "flatpakBody": "Le paquet s'installe manuellement (sideload). Retéléchargez-le pour le mettre à jour jusqu'à ce qu'Unisic arrive sur Flathub.",
    "debTitle": "deb, Arch",
    "debBody": "Installez le nouveau paquet par-dessus l'ancien. Vous préférez compiler depuis les sources ? Le README vous explique tout.",
